...
(function () {
  ...
  var scenarios = [
    ...
    { selected: 'The latest HbA1c finding is supported by the linked laboratory report and can be checked at its source.', prompt: 'Name the HbA1c value, date, laboratory, and source page.', ai: 'HbA1c is 6.1% (2026-Aug-14), linked to Metro Pathology, Page 3, for source review.', final: 'HbA1c is 6.1% (2026-Aug-14), linked to Metro Pathology, Page 3, for source review. Source checked during clinician review.' }
  ];
  var scenarioIndex = 0;
  var timers = [];
