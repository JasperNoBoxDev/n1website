      ...
      steps: [
        {
          ...
          html: `${head('Medical records · 14 records','Add medical records','PDF clinical documents and supported TXT, CSV or TSV data files.',button('+ Upload records'))}
            ...
            <div class="pth-card pth-upload-list"><div class="pth-file"><i class="pth-filetype">PDF</i><div><b>metro-pathology-mar-2025.pdf</b><small>12 pages · 2.4 MB</small></div><span class="pth-file-state">Ready</span></div><div class="pth-file"><i class="pth-filetype">PDF</i><div><b>consult-note-2025.pdf</b><small>6 pages · 1.1 MB</small></div><span class="pth-file-state">Ready</span></div><div class="pth-file"><i class="pth-filetype">CSV</i><div><b>genetics-export.csv</b><small>Supported raw data</small></div><span class="pth-file-state">Ready</span></div></div>`
        },
        {
          label: 'Transfer',
          ...
          html: `${head('Secure transfer','Three records are uploading','Each file has its own progress and retry state.','<span class="pth-chip">Encrypted transfer</span>')}
            <div class="pth-card pth-upload-list"><div class="pth-file"><i class="pth-filetype">PDF</i><div><b>metro-pathology-mar-2025.pdf</b><small>Valid PDF · 12 pages</small><div class="pth-meter"><i style="width:100%"></i></div></div><span class="pth-file-state">Uploaded ✓</span></div><div class="pth-file"><i class="pth-filetype">PDF</i><div><b>consult-note-2025.pdf</b><small>Transferring securely</small><div class="pth-meter"><i style="width:74%"></i></div></div><span class="pth-file-state">74%</span></div><div class="pth-file"><i class="pth-filetype">CSV</i><div><b>genetics-export.csv</b><small>Waiting for transfer</small><div class="pth-meter"><i style="width:18%"></i></div></div><span class="pth-file-state">Queued</span></div></div>`
        },
        {
          label: 'Process',
      ...
      steps: [
        ...
        },
        {
          ...
          html: `${head('Evidence check','LDL cholesterol · 116 mg/dL','Collected 14 Mar 2025 · fasting sample','<span class="pth-chip">Source page 3</span>')}
            <div class="pth-source-drawer"><div class="pth-card pth-source-copy"><b style="font-size:10px">Reading details</b><dl><div><dt>Reference range</dt><dd>≤100 mg/dL</dd></div><div><dt>Laboratory range</dt><dd>≤130 mg/dL</dd></div><div><dt>Fasting</dt><dd>Yes</dd></div><div><dt>Review state</dt><dd>Clinician check</dd></div></dl>${button('Edit patient range',true)}</div><div class="pth-card pth-source-page"><b>Metro Pathology</b>${line()}${line(true,'LDL cholesterol &nbsp; 116 mg/dL &nbsp; Reference ≤130')}${line()}${line()}${line()}</div></div>`
        },
        {
          label: 'Correct',
